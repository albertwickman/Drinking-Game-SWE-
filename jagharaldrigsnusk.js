const questions = [
    ...
    "Blivit fångad medan jag hade sex.",
    ...
    "Haft en sexdröm om någon i det här rummet.",
    "Haft sex med någon mer än 10 år äldre än mig.",
    "Blivit kär i någon jag bara haft sex med.",
    "Haft sex på en fest.",
    ...
    "Haft en långdistanssexrelation.",
    ...
    "Gjort slut med någon över text.",
    "Blivit kär vid första ögonkastet."
];
